    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-5 py-6 sm:px-6">
          {isViewMode && viewRequest?.hasDuplicateHistory ? (
            <div
              className="mb-4 flex items-start gap-2 rounded-lg border border-amber-500/40 bg-amber-500/10 px-3 py-2.5 text-sm text-amber-200"
              role="status"
            >
              ...
              <p>
                동일한 내용의 의뢰 이력이 있습니다.
                {viewRequest.duplicateOfRequestId
                  ? ' 담당자는 기존 의뢰와 비교·확인해 주세요.'
                  : ' 담당자는 기존 유사 의뢰와 비교·확인해 주세요.'}
              </p>
            </div>
          ) : null}
          <WarrantyIssuanceRequestForm
