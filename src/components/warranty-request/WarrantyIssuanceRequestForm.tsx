...
const toolbarStickyClass =
  'sticky top-[var(--app-header-offset)] z-40 -mx-3 mb-8 space-y-2 rounded-xl border border-border bg-bg-secondary/95 px-3 py-4 shadow-sm backdrop-blur-sm sm:-mx-6 sm:px-6'
